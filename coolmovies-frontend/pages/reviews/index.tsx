      ...
      <div css={styles.root}>
        ...
        <div css={styles.body}>
          ...
          <div css={styles.movieCovers}>
            {coolmoviesState.allMoviesData?.allMovies?.nodes?.map(
              (movieData) => {
                return (
                  <div
                    tabIndex={0}
                  ...
                  >
                    <Image
                      ...
                      onClick={() => {
                        ...
                        if (
                          coolmoviesState.selectedMovieData?.id != movieData.id
                        ) {
                        ...
                        dispatch(
                          coolmoviesActions.fetchReviewsByMovieId(movieData.id)
                        );
                      }}
                    />
                  </div>
            ...
            <div>
              ...
              >
                ...
                <Typography variant={"subtitle2"} css={styles.subtitle}>
                  {"Release date: " +
                    coolmoviesState.selectedMovieData.releaseDate}
                </Typography>
              </Box>
